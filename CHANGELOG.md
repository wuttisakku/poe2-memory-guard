...
- Removed legacy `Start-Memory-Guard.cmd`.
- Kept `PoE2MemoryGuard.cmd` as the only launcher users should run.
- Updated auto-update logic to stop copying the removed legacy launcher.
