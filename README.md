...
1. Double-click `Start-Memory-Guard.cmd`.
...
- If Windows blocks the launcher or RAMMap mode needs extra permission, right-click `Start-Memory-Guard.cmd` and select **Run as administrator**.
