...
1. Double-click `PoE2MemoryGuard.cmd`.
...
- If Windows blocks the launcher or RAMMap mode needs extra permission, right-click `PoE2MemoryGuard.cmd` and select **Run as administrator**.
